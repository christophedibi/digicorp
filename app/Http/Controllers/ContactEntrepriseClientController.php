...
use App\Models\ContactEntrepriseClient as Contact;
use App\Models\Client;

class ContactEntrepriseClientController extends Controller
{
    ...
    public function getIndex()
    {
        ...
        return view('pages.back.admin.clients.contacts.lister',$datas,$data);
    }

    public function getEditer(Contact $contact)
    {
        $entreprises = Client::where('status','=', 'entreprise')->get();
        return view('pages.back.admin.clients.contacts.editer',compact('contact','entreprises'));
    }

    public function getCreate()
    {
        $data['entreprises'] = Client::Where('status', '=', "entreprise")->get();
        return view('pages.back.admin.clients.contacts.creer',$data);
