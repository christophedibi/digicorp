            ...
            <div class="card-header">
              <div class="row">
                <div class="col-md-4 d-flex justify-content-start py-3">
                    <a href="{{route('lister-client')}}"  class="btn btn-primary"><i class="fa fa-user"></i> Liste des clients</a>
                </div>
                <div class="col-md-4 d-flex justify-content-center py-3">
                </div>
                <div class="col-md-4 d-flex justify-content-end py-3">
                    <a href="{{ route('creer-contact') }}"  class="btn btn-outline-primary"><i class="fa fa-plus"></i> Ajouter un contact</a>
                </div>
            </div>
            </div>
            <div class="card-body">
                     ...
                     <tr>
                      ...
                      <td>
                          <form action="{{ route('supprimer-contact',$contact->id) }}" method="Post">
                            <a class="btn btn-primary" href="{{ route('editer-contact',$contact->id) }}">
