@extends('pages.back.admin.master',['titre'=>'ENREGISTRER UN CONTACT FOURNISSEUR'])
@section('style')
...
<section class="forms"> 
    <div class="container-fluid">
      <div class="row">
        ...
        @endif
              <form class="form-horizontal" action="{{ route('creer-contact-fournisseur-post') }}" method="post" enctype="multipart/form-data">
                @csrf                    
