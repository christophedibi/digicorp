@extends('pages.back.admin.master',['titre'=>'ENREGISTRER UN CONTACT PRESTATAIRE'])
@section('style')
...
<section class="forms"> 
    <div class="container-fluid">
      <div class="row">
        ...
        @endif
              <form class="form-horizontal" action="{{ route('creer-contact-prestataire-post') }}" method="post" enctype="multipart/form-data">
                @csrf                    
