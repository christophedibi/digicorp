@extends('pages.back.admin.master',['titre'=>'AJOUTER UN PRESTATAIRE'])
@section('style')
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-4 d-flex justify-content-end py-3">
              <a href="{{ route('lister-prestataire') }}" class="btn btn-outline-primary"><i class="fa fa-arrow-circle-left"></i> Retour à la liste</a>
            </div>
          </div>
            ...
            @endif
              <div class="row form-control-lg">
                <div class="row">
                  <div class=" mt-5 form-check col-md-12 mb-3 row">
                    <h3>VEUILLEZ INDIQUER LE STATUS DU PRESTATAIRE</h3> 
              ...
              <div class="input-material-group mt-5 form-check col-md-12 mb-3 row" id="particulierForm" style="display:none;">
                <form class="form-horizontal" action="{{ route('creer-prestataire-post') }}" id="prestataireCreate" method="POST" enctype="multipart/form-data">
                  @csrf 
                ...
                <input class="btn btn-success" type="submit" value="Enregistrer le prestataire"/>
              </form>
              </div>
              {{-- ENTREPRISE --}}
