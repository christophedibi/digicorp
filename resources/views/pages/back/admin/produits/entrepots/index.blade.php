                            ...
                            <div class="card mb-0">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="staticLabel">ENREGISTREMENT D'UN NOUVELENTREPOT</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form class="form-horizontal"
                                                            action="{{ route('entrepots.store') }}" id=""
                                                            ...
                                                            <div class="form-control-group mb-4">
                                                                ...
                                                                <div class="form-control-group col-auto mb-3">
                                                                    <input class="form-control" id="contact"
                                                                        ...
                                                                        placeholder="contact *" required autocomplete>
                                                                </div>
                                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0  table-hover display" id="tableEntrepots">
                                            <thead>
                                                <tr>
                                                    <th>Nom</th>
                                                    <th>Localisation</th>
