<div class="page-content d-flex align-items-stretch">
    ...
    <nav class="side-navbar z-index-40">
        ...
        <div class="sidebar-header d-flex align-items-center py-4 px-2"><img
                class="digicorp shadow-0 img-fluid rounded-circle" src="img/favicon.ico" alt="...">
        ...
        <ul class="list-unstyled py-4">
                        ...
                        <li>
                            <a class="sidebar-item">
                                ...
                                <ul class="collapse list-unstyled " id="produitropdownDropdown">
                                    <li><a class="sidebar-link" href="{{ route('entrepots.index') }}">Entreprots</a>
                                    </li>
                                    <li><a class="sidebar-link" href="{{ route('marques.index') }}">Marque</a></li>
                                    <li><a class="sidebar-link" href="{{ route('categories.index') }}">Categorie</a>
                                    </li>
            ...
            <li class="sidebar-item"><a class="sidebar-link" href="#proforma" data-bs-toggle="collapse">
                    <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                        <use xlink:href="#browser-window-1"> </use>
                    </svg>FACTURES </a>
                <ul class="collapse list-unstyled " id="proforma">
                    <!--data-bs-toggle="modal" data-bs-target="#staticBackdrop"-->
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="statutClient" aria-hidden="true">
